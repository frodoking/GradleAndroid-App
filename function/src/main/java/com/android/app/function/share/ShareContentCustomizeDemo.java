...
import com.android.app.function.onekeyshare.ShareContentCustomizeCallback;
...
public class ShareContentCustomizeDemo implements ShareContentCustomizeCallback {
	...
	public void onShare(Platform platform, ShareParams paramsToShare) {
		...
		if (ShareActivity.TEST_TEXT != null && ShareActivity.TEST_TEXT.containsKey(id)) {
			String text = ShareActivity.TEST_TEXT.get(id);
