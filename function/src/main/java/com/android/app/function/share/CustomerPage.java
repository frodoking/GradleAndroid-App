...
public class CustomerPage extends SlidingMenuPage implements
	...
	public void onClick(View v) {
        ...
        if (i == R.id.btnDb) {
            doubanEvent();
        } else if (i == R.id.btnFb) {
            facebookEvent();
        } else if (i == R.id.btnRr) {
            renren();
        } else if (i == R.id.btnSw) {
            sinaWeibo();
        } else if (i == R.id.btnQz) {
            qzone();
        } else if (i == R.id.btnTc) {
            tencentWeibo();
        } else if (i == R.id.btnTw) {
            twitter();
        } else if (i == R.id.btnKx) {
            kaixin();
        } else if (i == R.id.btnYd) {
            youdaoNote();
        } else if (i == R.id.btnShSSK) {
            SohuSuishenkan();
        } else if (i == R.id.btnTumblr) {
            tumblr();
        }
	}
	...
	private void renren() {
		...
		filePathes.put("file", ShareActivity.TEST_IMAGE);
