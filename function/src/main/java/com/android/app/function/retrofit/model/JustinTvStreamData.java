package com.android.app.function.retrofit.model;

public class JustinTvStreamData {
	private boolean abuse_reported;
	private String audio_codec;
	private Number broadcast_part;
	private String broadcaster;
	private String category;
	private JustinTvChannel channel;
	private Number channel_count;
	private boolean channel_subscription;
	private Number channel_view_count;
	private Number embed_count;
	...
	public Number getBroadcast_part() {
		return this.broadcast_part;
	}

	public void setBroadcast_part(Number broadcast_part) {
	...
	public JustinTvChannel getChannel() {
		return this.channel;
	}

	public void setChannel(JustinTvChannel channel) {
		this.channel = channel;
	}

	public Number getChannel_count() {
		return this.channel_count;
	}

	public void setChannel_count(Number channel_count) {
		this.channel_count = channel_count;
	}

	public boolean getChannel_subscription() {
	...
	public Number getChannel_view_count() {
		return this.channel_view_count;
	}

	public void setChannel_view_count(Number channel_view_count) {
		this.channel_view_count = channel_view_count;
	}

	public Number getEmbed_count() {
		return this.embed_count;
	}

	public void setEmbed_count(Number embed_count) {
		this.embed_count = embed_count;
	}

	public boolean getEmbed_enabled() {
	...
	public Number getSite_count() {
		return this.site_count;
	}

	public void setSite_count(Number site_count) {
		this.site_count = site_count;
	}

	public Number getStream_count() {
		return this.stream_count;
	}

	public void setStream_count(Number stream_count) {
	...
	public Number getVideo_bitrate() {
		return this.video_bitrate;
	}

	public void setVideo_bitrate(Number video_bitrate) {
	...
	public Number getVideo_height() {
		return this.video_height;
	}

	public void setVideo_height(Number video_height) {
		this.video_height = video_height;
	}

	public Number getVideo_width() {
		return this.video_width;
	}

	public void setVideo_width(Number video_width) {
