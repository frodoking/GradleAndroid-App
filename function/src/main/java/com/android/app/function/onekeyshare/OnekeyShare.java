...
package com.android.app.function.onekeyshare;
    ...
    public void show(Context context) {
        ...
        try {
            if (OnekeyShareTheme.SKYBLUE == theme) {
                platformListFakeActivity = (PlatformListFakeActivity) Class.forName("com.android.app.function.onekeyshare.theme.skyblue.PlatformListPage").newInstance();
            } else {
                platformListFakeActivity = (PlatformListFakeActivity) Class.forName("com.android.app.function.onekeyshare.theme.classic.PlatformListPage").newInstance();
            }
        } catch (Exception e) {
            e.printStackTrace();
            return;
